        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/website" aria-current="page" class="<?=  urlIs('/website/')? 'bg-gray-900 text-white' : 'text-white' ?>  rounded-md  px-3 py-2 text-sm font-medium text-white">Home</a>
              <a href="about.php" class="<?=  urlIs('/website/about.php') ? 'bg-gray-900 text-white' : 'text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
              <a href="contact.php" class="<?=  urlIs('/website/contact.php') ? 'bg-gray-900 text-white' : 'text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
